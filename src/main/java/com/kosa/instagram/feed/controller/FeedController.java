...
public class FeedController {
   ...
   public String getMemberList(String keyword, String searchType, HttpSession session, Model model) {
...
//    	 List<FeedVo> hashtagList = feedService.searchListByHashtag(hashtagList);
